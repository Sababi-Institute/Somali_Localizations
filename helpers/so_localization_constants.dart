...
class SomaliLocalizationConstants {
  ...
  static const String languageCode = 'so';
   
   ///US Date Symbols taken from US definition of MaterialDateSymbols
   ///
...
///US Date Patterns, taken from US definition of MaterialDatePatters
///
  static Map<String, String> localeDatePatterns = {
  'd': 'd', // DAY
  'E': 'ccc', // ABBR_WEEKDAY
  'EEEE': 'cccc', // WEEKDAY
